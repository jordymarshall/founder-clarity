...
const Index = () => {
  ...
  return <AppLayout>
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        {currentView === 'ideas' && <IdeasHub onInvestigate={handleInvestigate} />}
        {currentView === 'workflow' && selectedIdea && <IdeaWorkflowLayout idea={selectedIdea} onBack={() => setCurrentView('ideas')} />}
      </div>
    </AppLayout>;
};
